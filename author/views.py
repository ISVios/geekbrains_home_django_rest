...
class PersoneModelViewSet(
    ...
    def get_serializer_class(self):
        ...
        if self.request.version == "v2":
            return author_selial.PersoneModelSerializerVer2
...
class TodoModelAPIView(APIView, LimitOffsetPagination):
    ...
    def get(self, request, pk=None, format=None):
        ...
        todo_page = self.paginate_queryset(todo_list, self.request, view=self)
        ser = author_selial.TodoModelSerilizer(instance=todo_page, many=True)
        response = {
    ...
    def put(self, request, pk=None, format=None):
        ...
        if data:
            obj = get_object_or_404(author_models.TodoModel, pk=data["pk"])
